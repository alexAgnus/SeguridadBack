...
var FileSystem = /** @class */ (function () {
    ...
    FileSystem.prototype.guardarImagenTemporal = function (file, userId) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            //Mover el archivo de temp a nustra carpeta
    ...
    FileSystem.prototype.imagenesTempHaciaPost = function (userId) {
        ...
        var imagenesTemp = this.obtenerImagensEnTemp(userId);
        imagenesTemp.forEach(function (imagen) {
            fs_1.default.renameSync(pathTemp + "/" + imagen, pathPost + "/" + imagen);
        });
        return imagenesTemp;
    };
    FileSystem.prototype.obtenerImagensEnTemp = function (userId) {
        var pathTemp = path_1.default.resolve(__dirname, '../uploads', userId, 'temp');
