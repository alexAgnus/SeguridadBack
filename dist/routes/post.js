...
postRoutes.post('/', [autenticacion_1.verificaToken], function (req, res) {
    ...
    var imagenes = fileSystem.imagenesTempHaciaPost(req.usuario._id);
    body.img = imagenes;
    post_model_1.Post.create(body).then(function (postDB) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, postDB.populate('usuario', '-password')];
                case 1:
                    _a.sent();
                    res.json({
                        ok: true,
...
postRoutes.get('/imagen/:userid/:img', function (req, res) {
    ...
    var tipo1 = req.params.tipo1;
    var tipo2 = req.params.tipo2;
